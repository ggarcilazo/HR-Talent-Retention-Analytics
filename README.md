...
* **El Factor Bienestar:** Los empleados con "Bajo" equilibrio vida-trabajo presentan una tasa de rotación significativamente superior al promedio general.
...
1. Descarga el archivo `.pbix` ubicado en la carpeta `/Dashboards`.
